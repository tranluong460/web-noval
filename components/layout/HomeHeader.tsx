            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex flex-1 max-w-lg mx-8">
                        <div className="relative w-full">
                            <input
                                ...
                                className="w-full px-4 py-2.5 pl-12 pr-4 text-slate-900 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-slate-500"
                            />
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button className="md:hidden p-2 text-slate-600 hover:text-blue-600 transition-all duration-200 hover:bg-gray-100 rounded-md">
                        ...
                        {navLinks.map((navItem, index) => (
                            navItem.type === 'link' ? (
                                <Link 
                                    key={index}
                                    href={navItem.href} 
                                    className="relative text-slate-700 hover:text-blue-600 font-medium transition-all duration-200 text-sm group"
                                >
                                    {navItem.title}
                                    <span className="absolute -bottom-3 left-0 w-0 h-0.5 bg-blue-600 group-hover:w-full transition-all duration-200"></span>
                                </Link>
                            ) : (
                                <div key={index} className="relative group">
                                    <button 
                                        className="relative text-slate-700 hover:text-blue-600 font-medium transition-all duration-200 flex items-center text-sm group"
                                        onMouseEnter={() => {
                                                    ...
                                                    <Link 
                                                        ...
                                                        className={`${
                                                            navItem.title === 'Thể loại' 
                                                                ...
                                                                : 'block px-3 py-2.5 text-sm text-slate-700 hover:text-blue-600 hover:bg-slate-100 transition-all duration-200 font-medium whitespace-nowrap'
                                                        }`}
                                                    >
                                                        {item.title}
                                                    </Link>
