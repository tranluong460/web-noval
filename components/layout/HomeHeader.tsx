...
import { Search, Menu, X, Sword, Wind, Mountain, Users, LogIn, UserPlus, Crown, Star, Zap, Cloud, ChevronDown } from 'lucide-react';
...
export default function HomeHeader() {
    ...
    return (
        <header className="min-height-screen relative bg-gradient-to-br from-slate-900 via-indigo-900 via-purple-900 to-slate-800 shadow-2xl sticky top-0 z-50 overflow-hidden">
            {/* Background effects */}
                    ...
                    <div className="flex-shrink-0">
                        <Link href="/" className="flex items-center space-x-3 group">
                            <div className="relative">
                                <div className="absolute -inset-3 bg-gradient-to-r from-cyan-500/30 via-blue-500/30 to-purple-500/30 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-700 blur-md"></div>
                                <div className="relative bg-gradient-to-br from-slate-800 via-indigo-800 to-purple-800 p-3 rounded-full shadow-2xl group-hover:shadow-cyan-500/50 transition-all duration-500 border border-cyan-400/30">
                                    <Sword className="h-6 w-6 lg:h-8 lg:w-8 text-cyan-300 group-hover:text-white transition-colors duration-300" />
                                </div>
                                <Wind className="absolute -top-1 -right-1 h-3 w-3 text-yellow-400 animate-bounce" />
                            </div>
                            <div className="flex flex-col">
                                <span className="text-xl lg:text-3xl font-black bg-gradient-to-r from-cyan-300 via-blue-300 to-purple-300 bg-clip-text text-transparent tracking-wider">
                                    逍遥仙境
                                </span>
                    ...
                    <nav className="hidden xl:flex space-x-1">
                        ...
                        <div className="relative group">
                            <button className="relative px-4 py-2.5 text-base text-slate-200 hover:text-cyan-200 font-semibold transition-all duration-300 rounded-lg flex items-center">
                                ...
                                <ChevronDown className="h-3 w-3 ml-1 text-yellow-400 group-hover:text-cyan-300" />
                            ...
                            <div className="absolute left-0 top-full mt-2 w-56 bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 border border-cyan-400/30 backdrop-blur-sm z-50">
                                <div className="py-2">
                                    <Link href="/top/tuan" className="flex items-center px-4 py-3 text-sm font-medium text-slate-200 hover:text-cyan-200 hover:bg-gradient-to-r hover:from-cyan-800/30 hover:to-blue-800/30 transition-all duration-200">
                                        <Zap className="h-4 w-4 mr-3 text-yellow-400" />
                                        🌟 Thiên Kiêu (Tuần)
                                    </Link>
                                    <Link href="/top/thang" className="flex items-center px-4 py-3 text-sm font-medium text-slate-200 hover:text-cyan-200 hover:bg-gradient-to-r hover:from-cyan-800/30 hover:to-blue-800/30 transition-all duration-200">
                                        <Crown className="h-4 w-4 mr-3 text-purple-400" />
                                        👑 Chí Tôn (Tháng)
                                    </Link>
                                    <Link href="/top/nam" className="flex items-center px-4 py-3 text-sm font-medium text-slate-200 hover:text-cyan-200 hover:bg-gradient-to-r hover:from-cyan-800/30 hover:to-blue-800/30 transition-all duration-200">
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-r from-pink-600/20 to-purple-600/20 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                        </Link>
                    </nav>
                ...
                {isMenuOpen && (
                    <div className="lg:hidden border-t border-cyan-400/20 absolute left-0 right-0 top-full bg-gradient-to-b from-slate-900/98 via-indigo-900/98 to-purple-900/98 backdrop-blur-md shadow-2xl z-40">
                        <div className="px-4 pt-4 pb-4 space-y-2 max-h-[calc(100vh-100px)] overflow-y-auto">
                            <Link
                                href="/"
                                className="flex items-center px-4 py-3 text-base font-medium text-slate-200 hover:text-cyan-200 hover:bg-gradient-to-r hover:from-cyan-600/20 hover:to-blue-600/20 rounded-lg transition-all duration-300"
